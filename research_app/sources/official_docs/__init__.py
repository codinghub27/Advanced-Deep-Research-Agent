...
from research_app.sources.official_docs.detector import DocsIntent, detect_docs_intent
...
__all__ = [
    ...
    "detect_docs_intent", "get_registry", "is_official", "load_entries", "merge_entries",
